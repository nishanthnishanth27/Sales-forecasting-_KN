...
Respond concisely and insightfully. Use $ for currency. Be data-driven.`,
  ...
  return (
   ...
   {aiLoading ? "ANALYZING..." : "AUTO ANALYZE"}
            </button>
          </div>

          {aiError && (
            <div style={{ color: "#ff4444", fontSize: 12, marginBottom: 12, padding: "8px 12px", background: "#ff444411", borderRadius: 8 }}>
              {aiError}
            </div>
          )}
          ...
          {chatHistory.length > 0 && (
            <div style={{
              ...
              background: "#060b14", borderRadius: 10, padding: 12, border: "1px solid #1e2530",
            }}>
              {chatHistory.map((m, i) => (
                <div key={i} style={{
                  ...
                  <div style={{ fontSize: 9, color: "#4a5568", marginBottom: 4, letterSpacing: 1 }}>
                    {m.role === "user" ? "YOU" : "FORECAST AI"}
                  </div>
                  <div style={{
                    background: m.role === "user" ? "#00e5ff15" : "#a855f715",
                    border: `1px solid ${m.role === "user" ? "#00e5ff22" : "#a855f722"}`,
                    borderRadius: 8, padding: "10px 14px", maxWidth: "90%",
                    color: m.role === "user" ? "#00e5ff" : "#e2e8f0",
              ...
              {aiLoading && (
                <div style={{ color: "#a855f7", fontSize: 11, padding: "8px 0" }}>
                  ● ● ● analyzing...
                </div>
              )}
              <div ref={chatEndRef} />
          ...
          <div style={{ display: "flex", gap: 8 }}>
            <input
              ...
              placeholder="Ask about the forecast, trends, features..."
              style={{
                flex: 1, background: "#0d1117", border: "1px solid #1e2530", borderRadius: 8,
                padding: "10px 14px", color: "#e2e8f0", fontSize: 12, fontFamily: "monospace",
                outline: "none",
              }}
            />
            <button onClick={handleChat} disabled={aiLoading || !chatInput.trim()} style={{
              background: "linear-gradient(135deg,#00e5ff,#a855f7)", color: "#060b14",
              border: "none", borderRadius: 8, padding: "10px 18px", fontFamily: "monospace",
